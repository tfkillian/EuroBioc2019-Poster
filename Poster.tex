...
\begin{minipage}[t]{\linewidth}
  ...
  % \begin{center}
  % \includegraphics[width=0.5\textwidth]{figs/delete.png}
  % \end{center}
  % \vspace{-0.5cm}
  % \captionof{figure}{\textbf{Mutation types for PIK3CA for all major cancer types.} \small Deleteriousness of mutation is highlighted.}
  % \label{fig:mutation}
